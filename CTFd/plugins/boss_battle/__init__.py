...
def load(app):
    ...
    register_plugin_stylesheet("/plugins/boss_battle/assets/boss.css?v=3")
    register_plugin_script("/plugins/boss_battle/assets/boss-sprites.js?v=3")
    register_plugin_script("/plugins/boss_battle/assets/boss.js?v=3")
