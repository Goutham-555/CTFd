...
def load(app):
    ...
    register_plugin_stylesheet("/plugins/boss_battle/assets/boss.css?v=6")
    register_plugin_script("/plugins/boss_battle/assets/boss-sprites.js?v=6")
    register_plugin_script("/plugins/boss_battle/assets/boss.js?v=6")
