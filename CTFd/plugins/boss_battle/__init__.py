...
def load(app):
    ...
    register_plugin_stylesheet("/plugins/boss_battle/assets/boss.css")
    register_plugin_script("/plugins/boss_battle/assets/boss-sprites.js")
    register_plugin_script("/plugins/boss_battle/assets/boss.js")
